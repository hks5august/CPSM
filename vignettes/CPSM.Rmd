...
## Using Your Own Data
The example above illustrates how to analyze data using the CPSM package with preloaded example data. If you have your own dataset in tab-separated (.txt, .tsv) or comma-separated (.csv) format, you can upload it as follows:
...
# Step3 -  Inspect the first few rows
#head(data[1:30)
...
Above code only demonstrates how user can loading their data; actual analysis steps (in examples) are performed using data of CPSM package here.
