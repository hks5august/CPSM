...
print(head(Example_TCGA_LGG_FPKM_data[1:30]),2)
...
print(head(train_FPKM[1:50]),5)

data(test_FPKM, package = "CPSM")

# View top rows and first 50 columns of data
print(head(test_FPKM[1:50]),5)
...
#load data - Normalized train and test data
