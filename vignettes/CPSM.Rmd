...
KM_plot <- km_overlay_plot_f(
  ...
  line_size = 1.2,                      # thicker lines
  train_palette = c("steelblue", "firebrick"), # custom colors for risk groups
  test_line_col = "darkgreen",          # test sample color
  test_line_type = "dashed"             # dashed test sample curve
)
